  ...
  Future<List<ZikerResponse>> getZikerList() {
    final listOfZikerModel = <ZikerResponse>[
      ...
      ZikerResponse(7, 'ما كان يقرأ به ﷺ في صلاة الفجر', [
        HadithResponse(
            1,
            'وكان يقرأ فيها ما بين الستين إلى المائة آية و كان يُطَوّل في الركعة الأولى، ويُقَصِّر في الثانية.',
        ...
        HadithResponse(
            2,
            'سورة (المؤمنون)\n'+
            'عن عبد الله بن السائب  قال: صلى لنا النبي  الصبح بمكة فاستفتح سورة «المؤمنين» حتى جاء ذكر موسى وهارون – أو ذكر عيسى – أخذت النبي  سعلةٌ فركع.',
        ...
        HadithResponse(
            2,
            'سورة (الروم)\n'+
            'عن شبيب أبي روح ، عن رجل من أصحاب النبي  عن النبي ، أنه صلى صلاة الصبح فقرأ الروم، فالتبس عليه، فلما صلى قال : " ما بال أقوام يصلون معنا، لا يحسنون الطهور، فإنما يلبس علينا القرآن أولئك ',
        ...
        HadithResponse(
            4,
            'سورة (يس)\n'+
            'عن جابر بن سَمُرة  أن النيي  كان يقرأ في الصبح بـ: {يس}( )',
            'رواه الطبراني في " الأوسط "، ورجاله رجال " الصحيح ". كذا " المجمع " (2/119) . وقال الامام الالباني رحمه الله في صفة صلاة النبي  ( 2/440) : {وسنده جيد. هذا هو الذي استقر عليه الرأي أخيراً؛ خلافاً لما كنت ذكرته في " تمام المنة "(ص 180) وغيره؛ فليُعلم} .'
            ,1, 0),
        HadithResponse(
            5,
            'سورة (الروم)\n'+
        ...
        HadithResponse(
            7,
            'سورة (ق)\n'+
            'عن قطبة بن مالك  قال: صليت وصلى بنا رسول الله  فقرأ: {قَ وَالْقُرْآنِ الْمَجِيدِ} حتى قرأ : {وَالنّخْلَ بَاسِقَاتٍ ...} ',
