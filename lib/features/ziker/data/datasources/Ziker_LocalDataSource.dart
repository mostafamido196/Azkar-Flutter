  ...
  Future<List<ZikerResponse>> getZikerList() {
    final listOfZikerModel = <ZikerResponse>[
      ...
      ZikerResponse(2, "أَذْكَارُ الصباح", <HadithResponse>[
        ...
        HadithResponse(2, "أصبحتُ أثني عليك حمدًا وأشهدُ أن لا إله إلا الله.  ",
            "أخرجه النسائي (10406) \"يقال ثلاث مرات.\"", 3, 0),
        HadithResponse(
            3,
      ...
      ZikerResponse(3, "الاذكار والدعوات دبر الصلواتَ المكتوبات", [
        ...
        HadithResponse(6, "ربِّ قِنِي عذابَك يومَ تبعَثُ عِبادَكَ. ",
            "رواه مسلم (709) ", 1, 0),
        HadithResponse(7, "اللهمَّ أعِنِّي على ذِكرِكَ وشُكرِكَ وحُسْنِ عبادتِكَ. ",
            "رواه أبو داود (1522)، وغيره. ", 1, 0),
        HadithResponse(
            8,
      ...
      ZikerResponse(4, "أَذْكَارُ المساء", [
        ...
        HadithResponse(9, "سبحان الله وبحمده  ", "أخرَجه مسلم (2692)\"يقال مائة مرة\"",
            100, 0),
        HadithResponse(
            10,
            "يا حي يا قيُّوم، برحمتك أستغيث، أصلِح لي شأني كلَّه، ولا تَكلني إلى نفسي طرْفة عين.  ",
      ...
      ZikerResponse(5, "أَذْكَارُ ما قبل النَّومِ", [
        ...
        HadithResponse(
            ...
            1,
            0),
        HadithResponse(7, "وضع اليد تحتَ الخد ثم يقول: (( اللهم باسمك أموت وأحيا)) ",
            "«البخاري 6324» ", 1, 0),
        HadithResponse(
            8,
        ...
        HadithResponse(
            ...
            1,
            0),
        HadithResponse(14, "قول: (( اللهمَّ قِني عذابك يوم تجمع أو تبعث عبادك)) ",
            "«الترمذي 3398» ", 1, 0),
        HadithResponse(
            15,
      ...
      ZikerResponse(
        ...
        [
          ...
          HadithResponse(
              ...
              1,
              0),
          HadithResponse(15, "ربِّ، قِني عذابَك يوم تبعثُ عبادَك.", "(مسلم 709)", 1, 0),
          HadithResponse(16, "أعوذ بكلماتِ اللهِ التامَّاتِ مِنْ شَرِّ ما خَلَق.",
              "(مسلم 2709)", 1, 0),
          HadithResponse(17, "أعوذُ باللهِ مِنَ الفِتَنِ؛ ما ظهَرَ منها وما بَطَن.",
              "(مسلم 2867)", 1, 0),
          HadithResponse(
              18,
